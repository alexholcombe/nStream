...
addpath(genpath('~/Google Drive/AllRSVP/DualRSVP/Exp2'));
cd('~/Google Drive/AllRSVP/DualRSVP/Exp2/Data/');
...
nSessions = 4;    
nModels = 2; %Gaussian then logNorm
...
% 
%                 pGuess = rand;
%                 muGuessLogNorm = ((3*rand)-1.5);
%                 sigmaGuessLogNorm = 2*rand;
%                 parameterGuessLogNorm = [pGuess muGuessLogNorm sigmaGuessLogNorm];
%                 parameterLowerBoundLogNorm = [0 -4 smallNonZeroNumber];
%                 parameterUpperBoundLogNorm = [1 4 5];
%             
%                 [currentEstimates, currentCIs] = mle(theseErrors, 'pdf', pdf_normmixture, 'start', parameterGuessLogNorm, 'lower', parameterLowerBoundLogNorm, 'upper', parameterUpperBoundLogNorm, 'options', options);
% 
%                 % Compute negative log likelihood
