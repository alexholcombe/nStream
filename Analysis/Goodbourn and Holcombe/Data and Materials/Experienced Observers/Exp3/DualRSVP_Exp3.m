...
saveDirectory = '/Users/experimentalmode/Documents/MATLAB/DualRSVP/Exp3/Data/';
userDirectory = '/Users/experimentalmode/Documents/MATLAB/DualRSVP/Exp3/UserData/';
nTrials = 25;            % 25
nPracticeTrials = 24;    % 24
nBlocks = 4;
nConditions = 4;
nSessions = 4;
...
userDataFile = [participantID '_DualRSVP_Exp3_UserData.mat'];
...
instructionText1 = ['On each trial, a rapid stream of letters ' ...
    ...
    'The locations of the two streams will be cued '...
    'before each trial.\n\n' ...
...
letterTheta = ([1 -1 -1 1]'*[-letterTheta/2 letterTheta/2])+repmat(pi/2*(0:3),2,1)';
...
for thisRect = 1:4
    ...
    cueRects(:,thisRect) = CenterRectOnPoint(cueRect, letterPosX(ceil(thisRect/2)), letterPosY(mod(thisRect-1,2)+1));

end

cueRectSelect = [1 2; 4 2; 3 4; 3 1];   % Correspondence between cue rects and letter rects
...
Screen('TextFont', ptbWindow, letterFont);
    ...
    for thisTrial = 1:totalTrials
        Screen('TextSize', ptbWindow, letterPoints);
        Screen('TextFont', ptbWindow, letterFont);sca
