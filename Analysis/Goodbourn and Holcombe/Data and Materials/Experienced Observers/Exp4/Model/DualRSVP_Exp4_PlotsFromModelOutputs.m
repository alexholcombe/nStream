...
conditionLabels = {'V-R','H-I','V-L','H-S'};
...
thisPlot = 0;
    ...
    for thisParameter = 1:nFreeParameters
        ...
        for thisStream = 1:nStreams
            ...
            scatter((1:4)+contingentModelJitter(1),standardEstimates,modelParamIcon{1});
            scatter((1:4)+contingentModelJitter(2),targetContingentEstimates,modelParamIcon{2});
            scatter((1:4)+contingentModelJitter(3),errorContingentEstimates,modelParamIcon{3});
    ...
    subplot(nParticipants+2,nFreeParameters,thisPlot);
        ...
        for thisStream = 1:nStreams
            ...
            scatter((1:4)+contingentModelJitter(1),standardMeans,modelParamIcon{1});
            scatter((1:4)+contingentModelJitter(2),targetContingentMeans,modelParamIcon{2});
            scatter((1:4)+contingentModelJitter(3),errorContingentMeans,modelParamIcon{3});
