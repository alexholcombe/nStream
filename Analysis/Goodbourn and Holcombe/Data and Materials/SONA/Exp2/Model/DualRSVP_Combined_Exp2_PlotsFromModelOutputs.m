...
cd('/Users/experimentalmode/Documents/MATLAB/DualRSVP_SONA/Exp2/Model');
load('DualRSVP_SONA_Exp2_ModelOutputs.mat');

% Cull participants
theseParticipants = setdiff(1:20,[1 10 20]);
% theseParticipants = 1:20;
...
EHI_Exp = [-200 375 325 300 -350 400];
allAge_Exp = NaN(1,6);
allSex_Exp = [1 1 1 0 0 1];
