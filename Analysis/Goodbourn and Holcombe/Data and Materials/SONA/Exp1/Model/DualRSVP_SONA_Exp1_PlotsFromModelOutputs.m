...
% Experiment 1 has 4 model conditions:
% 1. Dual-stream, all trials
% 2. Dual-stream, odd trials
% 3. Dual-stream, even trials
% 4. Single-stream, all trials

allReliability_byParticipant = allEstimates_byParticipant([2 3],:,:,:);
allEstimates_byParticipant = allEstimates_byParticipant([1 4],:,:,:);
