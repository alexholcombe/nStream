...
predictionPlot <- ggplot()+
  stat_function(data=data.frame(x=c(-400:800)/83.33), aes(x, fill = 'Eight Streams'), fun = dnorm, args = list(mean = meanLatencyExogenous/83.33, sd = meanPrecisionExogenous/83.33), geom='area', alpha = .9)+
  stat_function(data=data.frame(x=c(-400:800)/83.33), aes(x, fill = 'Two Streams'), fun = dnorm, args = list(mean = meanLatencyEndogenous/83.33, sd = meanPrecisionEndogenous/83.33), geom='area', alpha = .9)+
