...
BFs %>% group_by(Group) %>% summarise(buffering = length(which(preferredModel == 'Buffering')),
...
PrecisionNormScatter <- ggplot(wideFormatPrecision, aes(x=twoStreams, y=eightStreams))+
  geom_point(size = 4, alpha = .7)+
...
EfficacyNormScatter <- ggplot(wideFormatEfficacy, aes(x=twoStreams, y=eightStreams))+
  geom_point(size = 4, alpha = .7)+
...
# 
if(savePlots){
  ggsave(PrecisionNormPlot, file = '../plots/PrecisionNormViolin.png', height=15, width=20,units='cm')
  ggsave(LatencyNormPlot, file = '../plots/LatencyNormViolin.png', height=15, width=20,units='cm')
  ggsave(EfficacyNormPlot, file = '../plots/EfficacyNormViolin.png', height=15, width=20,units='cm')

  ggsave(PrecisionNormScatter, file = '../plots/PrecisionNormScatter.png', height=15, width=20,units='cm')
  ggsave(LatencyNormScatter, file = '../plots/LatencyNormScatter.png', height=15, width=20,units='cm')
  ggsave(EfficacyNormScatter, file = '../plots/EfficacyNormScatter.png', height=15, width=20,units='cm')


  ggsave(EfficacyNormBayesPlot, file = '../plots/EfficacyNormEffectSize.png', height=15, width=20,units='cm')
  ggsave(LatencyNormBayesPlot, file = '../plots/LatencyNormEffectSize.png', height=15, width=20,units='cm')
  ggsave(PrecisionNormBayesPlot, file = '../plots/PrecisionNormEffectSize.png', height=15, width=20,units='cm')
}
```
