...
for thisSample = 1:nSamples
    for thisParticipant = 1:nParticipants(thisSample)
        fprintf(writeFile,'\n%s,%s,%s,%s',participants{thisParticipant},conditionNames{thisSample},'Efficacy','Normal'); % Group
        for thisCondition = 1:nConditions
            for thisStream = 1:nStreams
...
for thisSample = 1:nSamples
    for thisParticipant = 1:nParticipants(thisSample)
        fprintf(writeFile,'\n%s,%s,%s,%s',participants{thisParticipant},conditionNames{thisSample},'Latency','Normal'); % Group
        for thisCondition = 1:nConditions
            for thisStream = 1:nStreams
...
for thisSample = 1:nSamples
    for thisParticipant = 1:nParticipants(thisSample)
        fprintf(writeFile,'\n%s,%s,%s,%s',participants{thisParticipant},conditionNames{thisSample},'Precision','Normal'); % Group
        for thisCondition = 1:nConditions
            for thisStream = 1:nStreams
