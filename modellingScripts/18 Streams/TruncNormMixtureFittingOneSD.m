...
dataDirectory = [usePath 'modelOutput/18Streams/compiled/'];



% Task parameters
sampleNames = {'2', '6', '18'}; %'Ex8Streams82msSOA', 'Ex6Streams115msSOA
...
cd([usePath 'modelOutput/18Streams/CSV/']);

% Accuracy
writeFile = fopen('TGRSVP_Exp2_AccuracyTruncNorm.csv','w');  % Overwrite file
...
save('truncNormalModelLikelihoodByParticipant', 'allMinNegLogLikelihoods_byParticipant', 'allNTrials_byParticipant')
save('truncNormalModelLikelihoodCombined', 'allMinNegLogLikelihoods_Combined', 'allNTrials_Combined')