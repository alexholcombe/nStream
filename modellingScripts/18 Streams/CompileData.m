...
allGroups = {'SONA/18Streams/2','SONA/18Streams/6','SONA/18Streams/18'};
baseDirectory = '~/gitCode/nStream/';
dataDirectory = [baseDirectory 'wrangledData/'];
saveDirectory = [baseDirectory 'modelOutput/18Streams/'];



% Specifiy the format of the data in the text file.
%
dataFormat = {'%s%d%s%d%d%s%d%d%s%s%d%d%d%d%d%d%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%d%d%s','%s%d%s%d%d%s%d%d%s%s%d%d%d%d%d%d%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%d%d%s','%s%d%s%d%d%s%d%d%s%s%d%d%d%d%d%d%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%d%d%s'};
...
dataColumns = {[8 16 1 6 36 3 14],[8 16 1 6 36 3 14],[8 16 1 6 36 3 14]};
