function result = TGAB_ExGauss_pdf_Mixture_Single(x,p,mu,sigma,tau)
    
    global xDomain;
    global pseudo_uniform;

    
    exGaussParams = [mu sigma tau];

%     fprintf('line 8\n')
    pseudo_normal = exgauss_pdf(xDomain, exGaussParams).*pseudo_uniform;
...
%     fprintf('line 22\n')
    ...
    normResultTemp = exgauss_pdf(x, exGaussParams).*uniResultTemp;
