...
dataFormat = {'%s%d%s%s%d%s%d%d%s%d%s%d%d%d%d%s%s%s%s%s%s%s%s%d%d%d','%s%d%s%s%d%s%d%d%s%d%s%d%d%d%d%s%s%s%s%s%s%s%s%d%d%d'};
...
dataColumns = {[25 15 4 9 26 3 13],[25 15 4 9 26 3 13]};
streams = [2 8];
