...
instructions1 = visual.TextStim(myWin,pos=(0,0),colorSpace='rgb',color= (1,1,1),alignHoriz='center', alignVert='center',height=1,units='deg',autoLog=autoLogging)
instructions2 = visual.TextStim(myWin,pos=(0,0),colorSpace='rgb',color= (1,1,1),alignHoriz='center', alignVert='center',height=1,units='deg',autoLog=autoLogging)

instructionText1 = """
This experiment is made up of several trials. On each trial you will fixate your eyes on a central point on the screen. Then several rapid, randomly-ordered sequences of letters will appear at two locations on the screen. You must not move your eyes from the fixation point while these sequences are playing.
...
instructionText2 ="""
At the end of each trial you will see a screen in which some letters are displayed. You should click on the letter that you saw within the circle.
...
startTrialStimuli = visual.TextStim(myWin,pos=(0,0),colorSpace='rgb',color= (1,1,1),alignHoriz='center', alignVert='center',height=1,units='deg',autoLog=autoLogging)
startTrialStimuli.text = 'Click here to start the trial'

startTrialBox = visual.Rect(myWin, height = 2.4, width = 12, units = 'deg', lineColor = bgColor, lineColorSpace = 'rgb')
...
#    print(correctIdx)
    ...
    if nDone is not 0:
        if  trials.nTotal/float(nDone) in [1.75,2.,4.]:
