...
tasks=['T1','T1T2','allCued','oneCued','nStream']
...
while not expStop:
    for n in xrange(20):
        ...
        responseLetterIdx = np.where(streamLetterIdentities[cuedStream,:]==responses[0])
        SPE = responseLetterIdx - cuePos
